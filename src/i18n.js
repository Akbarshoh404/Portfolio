...
const resources = {
  en: {
    translation: {
      ...
      "about_exp_field": "Frontend Development",
      "about_edu_label": "Education",
      "about_edu_school1": "IT-Academy",
      "about_edu_school2": "\"Muhammad Al-Xorazmiy\" School",
      "about_bio": "Hello! I am a passionate Front-End Developer from Uzbekistan, just 15 years old but with 2 years of hands-on experience in the industry. I've had the privilege of working on diverse projects, refining my skills in creating dynamic, responsive/animated, and user-friendly interfaces. I am constantly pushing the boundaries of what's possible in web and mobile development.",
      // Experience
  ...
  ru: {
    translation: {
      ...
      "about_exp_value": "2+ года",
      "about_exp_field": "Frontend разработка",
      "about_edu_label": "Образование",
      "about_edu_school1": "IT-Academy",
      "about_edu_school2": "Школа \"Мухаммад Аль-Хоразмий\"",
      "about_bio": "Привет! Я увлечённый Frontend-разработчик из Узбекистана, мне всего 15 лет, но за плечами уже 2 года практического опыта в отрасли. Я работал над разнообразными проектами, совершенствуя навыки создания динамичных, адаптивных и анимированных интерфейсов. Я постоянно расширяю границы возможного в веб и мобильной разработке.",
      // Experience
  ...
  uz: {
    translation: {
      ...
      "about_exp_value": "2+ yil",
      "about_exp_field": "Frontend dasturlash",
      "about_edu_label": "Ta'lim",
      "about_edu_school1": "IT-Academy",
      "about_edu_school2": "\"Muhammad Al-Xorazmiy\" Maktabi",
      "about_bio": "Salom! Men O'zbekistondan ishtiyoqli Frontend-dasturchi bo'lib, atigi 15 yoshimda 2 yillik amaliy tajribaga egaman. Turli loyihalarda ishlash imkoniga ega bo'ldim va dinamik, moslashuvchan va foydalanuvchiga qulay interfeyslar yaratish ko'nikmalarini chipdim. Men veb va mobil dasturlash sohasida doimo yangi imkoniyatlarni qidirib kelmoqdaman.",
      // Experience
